...
| *Переупорядочивание элементов в списке* | 1.67 +- 0.35% | 1.43 +- 0.01 (+23%)|
| *Оптимизация strncmp* | 1.55 +- 0.43% | 1.54 +- 0.02 (+8%)|
| *Оптимизация crc32 с использованием Intel Intrinsics* | 1.44 +- 0.24% | 1.65 +- 0.02 (+7%)|
| *Оптимизация crc32 c использованием \_\_asm\_\_ volatile* | 1.38 +- 0.54% | 1.72 +- 0.02 (+4%) |
