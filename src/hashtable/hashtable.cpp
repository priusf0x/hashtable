...
//
// inline uint32_t
// crc32(string_s string)
// {
//         const uint8_t *p = (const uint8_t*) string.string;
//         uint32_t crc;
//
//         crc = ~0U;
//         while (string.size--)
...
InlineHashCRC32(string_s string)
{
    uint32_t crc = ~0u;
         ...
         string_s    elem)
{
    ...
    return InlineHashCRC32(elem) % TABLE_SIZE;
}
...
static inline void 
InlinedGetString(const list_t list,
                 ...
                 string_s    elem)
{
    ...
    else 
    {
        ...
        do
        {
            ...
            InlinedGetString(list, list_index, &cmp_string);
